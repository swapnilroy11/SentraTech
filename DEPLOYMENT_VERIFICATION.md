...
curl -X POST "https://ux-legal-revamp.preview.emergentagent.com/api/ingest/demo_requests" \
...
1. Go to https://ux-legal-revamp.preview.emergentagent.com/roi-calculator
...
```bash
curl -s https://ux-legal-revamp.preview.emergentagent.com/api/health
