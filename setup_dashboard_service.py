...
autostart=true
autorestart=true
environment=APP_URL="https://dashboard-bridge-2.preview.emergentagent.com",INTEGRATION_PROXY_URL="https://integrations.emergentagent.com"
...
"""
    ...
    print("✅ Updated supervisor configuration with dashboard service")
    print("📁 Configuration saved to:", config_path)
    
def show_service_info():
    """Show service configuration information"""
    print("\n" + "="*50)
    print("🚀 SENTRATECH SERVICES CONFIGURATION")
    print("="*50)
    print("🔧 Backend API: Port 8001")
    print("🌐 Website: Port 3000 (sentratech.net)")
    print("📊 Dashboard: Port 3001 (admin.sentratech.net)")
    print("🗄️  MongoDB: Default port")
    print("\n📋 Service Commands:")
...
if __name__ == "__main__":
    print("🔧 Setting up SentraTech Dashboard Service...")
    ...
    print("   sudo supervisorctl restart all")
    print("\n✅ Dashboard service configuration complete!")