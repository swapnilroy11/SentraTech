...
3. **Run verification**:
   ...
   export ADMIN_URL="https://sentra-forms.preview.emergentagent.com"
...
```bash
curl -s https://sentra-forms.preview.emergentagent.com/api/health
```
**Expected**: `{"ingest_configured": true, "mock": false}`

### **2. Admin Proxy Diagnostics**  
```bash
curl -s https://sentra-forms.preview.emergentagent.com/api/_diag/upstream
```
...
- Open browser to `https://sentra-forms.preview.emergentagent.com`
