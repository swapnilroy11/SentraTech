...
3. **Run verification**:
   ...
   export ADMIN_URL="https://form-simulator.preview.emergentagent.com"
...
```bash
curl -s https://form-simulator.preview.emergentagent.com/api/health
```
**Expected**: `{"ingest_configured": true, "mock": false}`

### **2. Admin Proxy Diagnostics**  
```bash
curl -s https://form-simulator.preview.emergentagent.com/api/_diag/upstream
```
...
- Open browser to `https://form-simulator.preview.emergentagent.com`
