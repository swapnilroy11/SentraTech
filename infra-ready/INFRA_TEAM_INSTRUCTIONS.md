...
3. **Run verification**:
   ...
   export ADMIN_URL="https://tech-careers-3.preview.emergentagent.com"
...
```bash
curl -s https://tech-careers-3.preview.emergentagent.com/api/_diag/upstream
```
...
- Open browser to `https://tech-careers-3.preview.emergentagent.com`
