...
3. **Run verification**:
   ...
   export ADMIN_URL="https://formforward.preview.emergentagent.com"
...
```bash
curl -s https://formforward.preview.emergentagent.com/api/_diag/upstream
```
...
- Open browser to `https://formforward.preview.emergentagent.com`
