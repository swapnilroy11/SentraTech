...
3. **Run verification**:
   ...
   export ADMIN_URL="https://tech-site-boost.preview.emergentagent.com"
...
```bash
curl -s https://tech-site-boost.preview.emergentagent.com/api/_diag/upstream
```
...
- Open browser to `https://tech-site-boost.preview.emergentagent.com`
