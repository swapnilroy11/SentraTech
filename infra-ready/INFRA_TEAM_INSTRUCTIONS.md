...
3. **Run verification**:
   ...
   export ADMIN_URL="https://react-rescue-4.preview.emergentagent.com"
...
```bash
curl -s https://react-rescue-4.preview.emergentagent.com/api/health
```
**Expected**: `{"ingest_configured": true, "mock": false}`

### **2. Admin Proxy Diagnostics**  
```bash
curl -s https://react-rescue-4.preview.emergentagent.com/api/_diag/upstream
```
...
- Open browser to `https://react-rescue-4.preview.emergentagent.com`
