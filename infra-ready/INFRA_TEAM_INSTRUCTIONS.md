...
3. **Run verification**:
   ...
   export ADMIN_URL="https://admin-matrix.preview.emergentagent.com"
...
```bash
curl -s https://admin-matrix.preview.emergentagent.com/api/_diag/upstream
```
...
- Open browser to `https://admin-matrix.preview.emergentagent.com`
