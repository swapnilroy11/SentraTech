...
3. **Run verification**:
   ...
   export ADMIN_URL="https://netproxy-forms.preview.emergentagent.com"
...
```bash
curl -s https://netproxy-forms.preview.emergentagent.com/api/_diag/upstream
```
...
- Open browser to `https://netproxy-forms.preview.emergentagent.com`
