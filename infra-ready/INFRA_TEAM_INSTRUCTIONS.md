...
3. **Run verification**:
   ...
   export ADMIN_URL="https://unified-forms.preview.emergentagent.com"
...
```bash
curl -s https://unified-forms.preview.emergentagent.com/api/_diag/upstream
```
...
- Open browser to `https://unified-forms.preview.emergentagent.com`
