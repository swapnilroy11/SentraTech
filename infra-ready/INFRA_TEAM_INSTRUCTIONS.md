...
3. **Run verification**:
   ...
   export ADMIN_URL="https://customer-flow-5.preview.emergentagent.com"
...
```bash
curl -s https://customer-flow-5.preview.emergentagent.com/api/_diag/upstream
```
...
- Open browser to `https://customer-flow-5.preview.emergentagent.com`
