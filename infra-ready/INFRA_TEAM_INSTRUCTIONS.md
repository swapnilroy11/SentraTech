...
3. **Run verification**:
   ...
   export ADMIN_URL="https://customer-dashboard-3.preview.emergentagent.com"
...
```bash
curl -s https://customer-dashboard-3.preview.emergentagent.com/api/_diag/upstream
```
...
- Open browser to `https://customer-dashboard-3.preview.emergentagent.com`
