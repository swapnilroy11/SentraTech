...
import { ArrowLeft, Linkedin, Mail, Users, Award, Globe, Zap } from 'lucide-react';
              ...
              <div key={index} className="bg-[rgb(38,40,42)] border border-[rgb(63,63,63)] rounded-2xl p-8 hover:border-[#00FF41]/30 transition-all duration-300">
                ...
                <div className="flex justify-center space-x-4">
                  ...
                  >
                    ...
                    <svg width={16} height={16} viewBox="0 0 24 24" fill="currentColor" className="text-[#00FF41]">
