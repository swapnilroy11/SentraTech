  ...
  return (
    <div className="min-h-screen bg-[rgb(18,18,18)] text-white">
      <SEOManager 
        ...
        description="SentraTech is seeking $80,000 in pre-seed funding to scale AI-powered customer support automation. Learn about our investment opportunity, market validation, and growth potential."
