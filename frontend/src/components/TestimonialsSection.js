                ...
                <div className="flex items-center justify-between mb-8">
                  ...
                  <div className="flex items-center space-x-1">
                    {[...Array(currentTestimonial.rating)].map((_, i) => (
                      <Star key={i} size={20} className="text-[#DAFF01] fill-current" />
                    ))}
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-1">
                      {[...Array(testimonial.rating)].map((_, i) => (
                        <Star key={i} size={12} className="text-[#DAFF01] fill-current" />
                      ))}
                    </div>
                  </div>
                </div>
        ...
        <div className="bg-gradient-to-r from-[rgb(26,28,30)] to-[rgb(38,40,42)] rounded-3xl p-12 border border-[rgba(255,255,255,0.1)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-[#DAFF01] mb-2">94%</div>
