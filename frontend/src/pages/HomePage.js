                  ...
                  <Card className="bg-[rgb(26,28,30)] border border-[rgba(255,255,255,0.1)] hover:border-[rgba(0,255,65,0.3)] hover:shadow-lg hover:shadow-[rgba(0,255,65,0.2)] transition-all duration-300 h-full group cursor-pointer transform hover:scale-[1.02] card-hover-enhanced hover-only">
                    <CardContent className="p-8">
                      <div className="flex items-center space-x-4 mb-6">
                        <div 
                          className="w-16 h-16 rounded-xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 icon-hover-enhanced group-hover-bg"
            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ duration: 0.6, delay: index * 0.2 }}
                  className="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300 hover-only"
                >
                  <div className="w-20 h-20 bg-[rgba(0,255,65,0.1)] hover:bg-[rgba(0,255,65,0.2)] rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 icon-hover-enhanced group-hover-scale group-hover-bg">
