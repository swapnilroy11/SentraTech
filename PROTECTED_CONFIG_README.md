...
curl -s "https://react-rescue-4.preview.emergentagent.com/api/config/validate" | jq .
```
...
curl "https://react-rescue-4.preview.emergentagent.com/api/config/validate"

# Test form submission
curl -X POST "https://react-rescue-4.preview.emergentagent.com/api/ingest/demo_requests" \
