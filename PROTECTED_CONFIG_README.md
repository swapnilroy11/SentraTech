...
curl -s "https://deploy-bug-fixes.preview.emergentagent.com/api/config/validate" | jq .
```
...
curl "https://deploy-bug-fixes.preview.emergentagent.com/api/config/validate"

# Test form submission
curl -X POST "https://deploy-bug-fixes.preview.emergentagent.com/api/ingest/demo_requests" \
