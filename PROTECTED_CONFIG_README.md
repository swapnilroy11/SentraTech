...
curl -s "https://matrix-team-update.preview.emergentagent.com/api/config/validate" | jq .
```
...
curl "https://matrix-team-update.preview.emergentagent.com/api/config/validate"
