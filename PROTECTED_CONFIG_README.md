...
curl -s "https://sentra-deploy-fix.preview.emergentagent.com/api/config/validate" | jq .
```
...
curl "https://sentra-deploy-fix.preview.emergentagent.com/api/config/validate"

# Test form submission
curl -X POST "https://sentra-deploy-fix.preview.emergentagent.com/api/ingest/demo_requests" \
